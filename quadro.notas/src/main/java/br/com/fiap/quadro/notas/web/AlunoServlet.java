...
public class AlunoServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		Aluno a = new AlunoDAO().consultorPorNome(nome);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(nome == null || sP1 == null || sP2 == null) {
			...
			if( bo.validarNota(a.getP1()) && bo.validarNota(a.getP2())) {
				...
				out.println("<h1>O aluno "+ a.getNome()+" foi cadastrado com sucesso, junto com suas notas.</h1>");
			}else {
				out.println("<h1 syle=\"color:red\">As notas precisam estar entre 0 e 10! </h1>");				
			}
		}
